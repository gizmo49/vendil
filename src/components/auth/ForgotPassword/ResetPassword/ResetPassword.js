...
import PasswordRules from "../../Register/CreatePassword/PasswordRules/PasswordRules";
import validatePassword from "../../Register/CreatePassword/PasswordRules/validatePassword";
...
class ResetPassword extends Component {
    ...
    CreatePassword = () => {
        ...
        API({
            MethodType: 'POST',
            RequestUri: routes.resetPassword,
            Payload: { ...request },
...
export default connect((state) => ({ regProps: state.forgotPassword }), null)(ResetPassword);